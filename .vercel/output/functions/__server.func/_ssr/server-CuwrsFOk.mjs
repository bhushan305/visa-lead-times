...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BZbkv0WC.mjs");
...
const manifest = {
  "24437f18c155a1da8afb8a099ea8efa86f342257f84afff9447c166341defc87": {
    ...
    importer: () => import("./case.functions-CUnteEsd.mjs")
  },
  "25a4e34d5c9aadbbc31fee205219011bbacd45bfa7d839be08d3375d38c7388f": {
    functionName: "submitFeedback_createServerFn_handler",
    importer: () => import("./feedback-C8K6jjfd.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CNCJAWJW.mjs").then((n) => n.r),
    import("./start-DgrjdGK4.mjs"),
